...
import TheObservedPIN.ObservedPin;
...
public class Main {
    ...
    private static void test(String entered, List<String> expected, List<String> result) {
        result.sort(comp);
        expected.sort(comp);
        Boolean res = result.removeIf(s -> expected.contains(s));
        System.out.println("Entered: " + entered + " Expected: " + expected + " Result: " + result + " Passed: " + res + "\n");
    }
}